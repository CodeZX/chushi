...
+(void)GET:(NSString *)url baseURL:(NSString *)baseUrl params:(NSDictionary *)params
   success:(LHResponseSuccess)success fail:(LHResponseFail)fail{
    ...
    AFHTTPSessionManager *manager = [HttpTool managerWithBaseURL:baseUrl sessionConfiguration:NO];
...
+(void)uploadWithURL:(NSString *)url
    ...
    AFHTTPSessionManager *manager = [HttpTool managerWithBaseURL:baseurl sessionConfiguration:YES];
