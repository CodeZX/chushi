...
@implementation WYCHomeCell

+ (instancetype)cellWithTableView:(UITableView *)tableView{
    WYCHomeCell * cell = [tableView dequeueReusableCellWithIdentifier:[WYCHomeCell ID]];
//    cell.backgroundColor = [UIColor redColor];
    cell = [[WYCHomeCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:[WYCHomeCell ID]];
